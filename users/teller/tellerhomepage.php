...
<body>
    ...
    <div class="container-fluid">
        <div class="row home-info">
            ...
            <div class="col-12 col-lg-4 teller-info p-4 mt-3">
                
                <div class="wallet-balance">
                    <b class="wallet-label">RUNNING BALANCE</b>
                    <div class="balance-amount"><?=(!empty($total_balance['wallet_balance']))? "₱".sprintf("%1\$.2f", $_SESSION['wallet_balance']):"₱0" ?></div>
                </div>
                
                <div class="collection">
                    <b class="collection-label">DAILY COLLECTION</b>
                    <div class="collection-balance"><?=(!empty($total_collection['total_amount']))? "₱".sprintf("%1\$.2f", $total_collection['total_amount']): "₱0" ?></div>
                    <div id="date"></div>
                </div>
                
                <div class="d-flex flex-column align-items-center summary-income p-lg-3">
                    <div class="summart-label"><b>STORE PERFORMANCE</b></div>
