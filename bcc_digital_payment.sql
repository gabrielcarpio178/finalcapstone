...
(2, 'good day', '2023-09-12 15:25:12', 'All', 'not-active'),
...
(7, 'upload product not available right now', '2023-09-12 21:33:00', 'Canteen Staff', 'active'),
...
--
-- Table structure for table `cashiertransaction_tb`
--

CREATE TABLE `cashiertransaction_tb` (
  `cashierTransaction_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `transactionDate` date NOT NULL,
  `transactionTime` time NOT NULL,
  `Amount` int(11) NOT NULL,
  `transactionActivity` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `order_tb` (`order_id`, `user_id`, `teller_id`, `product_id`, `orderproduct_name`, `order_num`, `order_productcategory`, `order_time`, `deadline_time`, `order_amount`, `order_quantity`, `statues`) VALUES
(2, 40, 1, 1, 'Mountain dew', '3948571930', 'Drinks', '2023-08-22 22:53:14', '2023-08-22 23:03:46', 15, 1, 'PROCEED'),
(6, 40, 1, 1, 'Mountain dew', '8894829058', 'Drinks', '2023-08-23 14:11:14', '2023-08-23 14:21:35', 15, 1, 'PROCEED'),
(10, 40, 1, 1, 'Mountain dew', '9540188489', 'Drinks', '2023-08-24 10:36:10', '2023-08-24 11:09:08', 60, 3, 'PROCEED'),
(12, 40, 1, 1, 'Mountain dew', '7492883020', 'Drinks', '2023-08-24 11:32:46', '2023-08-24 13:36:27', 40, 2, 'PROCEED'),
(13, 40, 1, 10, 'Coke', '2380384410', 'Drinks', '2023-08-24 11:58:57', '2023-08-24 12:09:18', 40, 2, 'PROCEED'),
(14, 40, 1, 1, 'Mountain dew', '2380384410', 'Drinks', '2023-08-24 11:58:57', '2023-08-24 12:09:18', 20, 1, 'PROCEED'),
(15, 40, 1, 10, 'Coke', '6383295510', 'Drinks', '2023-08-24 12:00:27', '2023-08-24 12:11:37', 20, 1, 'PROCEED'),
(18, 38, 1, 1, 'Mountain dew', '6383295511', 'Drinks', '2023-08-24 13:05:36', '2023-08-24 13:33:21', 20, 1, 'PROCEED'),
(20, 38, 1, 1, 'Mountain dew', '6383295512', 'Drinks', '2023-08-24 13:31:34', '2023-08-24 13:41:58', 20, 1, 'PROCEED'),
(22, 41, 1, 1, 'Mountain dew', '6383295513', 'Drinks', '2023-08-24 20:01:17', '2023-08-24 20:12:11', 20, 1, 'PROCEED'),
(23, 33, 1, 1, 'Mountain dew', '6383295514', 'Drinks', '2023-08-24 20:03:53', '2023-08-24 20:15:08', 20, 1, 'PROCEED'),
(26, 37, 1, 1, 'Mountain dew', '6383295515', 'Drinks', '2023-08-25 13:25:50', '2023-08-25 13:36:17', 20, 1, 'PROCEED'),
(28, 36, 1, 10, 'Coke', '6383295516', 'Drinks', '2023-08-26 00:01:47', '2023-08-27 10:43:51', 20, 1, 'PROCEED'),
(33, 45, 1, 1, 'Mountain dew', '9785410212', 'Drinks', '2023-08-26 12:03:44', '2023-08-26 12:15:18', 20, 1, 'PROCEED'),
(34, 34, 1, 10, 'Coke', '7914538602', 'Drinks', '2023-08-26 12:14:10', '2023-08-26 12:24:35', 20, 1, 'PROCEED'),
(36, 34, 1, 1, 'Mountain dew', '7914538602', 'Drinks', '2023-08-26 12:14:10', '2023-08-26 12:24:35', 20, 1, 'PROCEED'),
(37, 41, 1, 10, 'Coke', '6103792458', 'Drinks', '2023-08-26 15:46:45', '2023-08-27 10:41:34', 20, 1, 'PROCEED'),
(39, 41, 1, 1, 'Mountain dew', '6103792458', 'Drinks', '2023-08-26 15:46:45', '2023-08-27 10:41:34', 20, 1, 'PROCEED'),
(41, 35, 1, 1, 'Mountain dew', '1605379842', 'Drinks', '2023-08-27 10:18:10', '2023-08-27 10:58:37', 20, 1, 'PROCEED'),
(43, 33, 1, 1, 'Mountain dew', '3672150984', 'Drinks', '2023-08-27 10:20:51', '2023-08-27 10:51:13', 20, 1, 'PROCEED'),
(45, 40, 1, 1, 'Mountain dew', '8751926304', 'Drinks', '2023-08-27 11:34:49', '2023-08-27 17:18:19', 20, 1, 'PROCEED'),
(47, 40, 1, 1, 'Mountain dew', '3296078451', 'Drinks', '2023-08-27 17:18:08', '2023-08-27 17:48:29', 20, 1, 'PROCEED'),
(49, 41, 1, 10, 'Coke', '3149082675', 'Drinks', '2023-08-27 17:23:37', '2023-08-27 17:54:00', 20, 1, 'PROCEED'),
(51, 45, 1, 1, 'Mountain dew', '6708429351', 'Drinks', '2023-08-27 18:02:55', '2023-08-27 18:13:14', 20, 1, 'PROCEED'),
(54, 40, 1, 1, 'Mountain dew', '1543902867', 'Drinks', '2023-08-27 18:09:37', '2023-08-27 18:11:05', 20, 1, 'PROCEED'),
(55, 40, 1, 1, 'Mountain dew', '4136079582', 'Drinks', '2023-08-27 18:57:02', '2023-08-27 18:59:21', 20, 1, 'PROCEED'),
(57, 41, 1, 1, 'Mountain dew', '9602547381', 'Drinks', '2023-08-27 19:01:37', '2023-08-27 19:02:57', 20, 1, 'PROCEED'),
(59, 45, 1, 1, 'Mountain dew', '8276514930', 'Drinks', '2023-08-27 19:02:33', '2023-08-27 19:04:54', 20, 1, 'PROCEED'),
(61, 37, 1, 1, 'Mountain dew', '2398165704', 'Drinks', '2023-08-27 22:33:34', '2023-08-27 22:43:55', 20, 1, 'PROCEED'),
(63, 40, 1, 1, 'Mountain dew', '4238750619', 'Drinks', '2023-08-27 22:36:48', '2023-08-27 22:39:11', 20, 1, 'PROCEED'),
(65, 36, 1, 1, 'Mountain dew', '8063592417', 'Drinks', '2023-08-27 22:40:46', '2023-08-27 22:43:07', 20, 1, 'PROCEED'),
(73, 37, 1, 10, 'Coke', '8352196740', 'Drinks', '2023-08-28 00:21:22', '2023-08-28 00:26:42', 20, 1, 'PROCEED'),
(77, 40, 1, 1, 'Mountain dew', '8604175932', 'Drinks', '2023-08-28 00:30:01', '2023-08-28 00:30:18', 20, 1, 'PROCEED'),
(79, 34, 1, 1, 'Mountain dew', '6041327895', 'Drinks', '2023-08-28 00:37:00', '2023-08-28 00:48:11', 20, 1, 'PROCEED'),
(81, 33, 1, 1, 'Mountain dew', '5187029346', 'Drinks', '2023-08-28 00:54:08', '2023-08-28 01:14:00', 20, 1, 'PROCEED'),
(87, 45, 1, 1, 'Mountain dew', '0831562479', 'Drinks', '2023-08-28 10:44:11', '2023-08-28 10:55:47', 20, 1, 'PROCEED'),
(89, 33, 1, 10, 'Coke', '2851069347', 'Drinks', '2023-08-28 11:40:25', '2023-08-29 23:26:23', 20, 1, 'PROCEED'),
(92, 40, 1, 18, 'Hansel', '7691852403', 'Biscuit ', '2023-08-29 23:15:26', '2023-08-29 23:45:47', 7, 1, 'PROCEED'),
(93, 40, 1, 16, 'mountain dew', '7691852403', 'Drinks', '2023-08-29 23:15:26', '2023-08-29 23:45:47', 20, 1, 'PROCEED'),
(94, 40, 1, 19, 'showbear', '3608945271', 'Candy', '2023-09-10 22:50:32', '2023-09-10 23:11:01', 2, 1, 'PROCEED'),
(95, 40, 1, 16, 'mountain dew', '3608945271', 'Drinks', '2023-09-10 22:50:32', '2023-09-10 23:11:01', 20, 1, 'PROCEED'),
(96, 46, 2, 26, 'Fita', '1935867402', 'Biscuit ', '2023-09-11 13:56:08', NULL, 16, 2, NULL),
(97, 46, 2, 23, 'Iced Coffee', '1935867402', 'Coolers', '2023-09-11 13:56:08', NULL, 30, 1, NULL),
(98, 40, 2, 23, 'Iced Coffee', '8639205174', 'Coolers', '2023-09-11 13:59:28', NULL, 60, 2, NULL),
(99, 40, 1, 16, 'mountain dew', '8639205174', 'Drinks', '2023-09-11 13:59:28', NULL, 40, 2, NULL),
(100, 40, 1, 17, 'Fita', '8639205174', 'Biscuit ', '2023-09-11 13:59:28', NULL, 16, 2, NULL),
(101, 47, 2, 28, 'Hansel', '0698145237', 'Biscuit ', '2023-09-11 14:05:15', NULL, 16, 2, NULL),
(102, 47, 2, 23, 'Iced Coffee', '0698145237', 'Coolers', '2023-09-11 14:05:15', NULL, 30, 1, NULL),
(103, 45, 2, 23, 'Iced Coffee', '4526937108', 'Coolers', '2023-09-11 14:30:34', '2023-09-11 14:46:45', 30, 1, 'PROCEED');
...
(17, 15, 1, 'Fita', 8, 200, 150, '2023-08-29', 'fita-64fdd6e8d8944.jpeg'),
(18, 15, 1, 'Hansel', 7, 199, 180, '2023-08-29', 'hansel-choco-sandwich-64ee0ae77871c.jpg'),
(19, 16, 1, 'showbear', 2, 199, 200, '2023-09-10', 'snowbear-64fdd755b51b4.jpg'),
(20, 16, 1, 'maxx', 2, 200, 200, '2023-09-10', 'maxx-64fdd7933fe07.jpg'),
(21, 13, 1, 'Dutch Mill', 25, 20, 400, '2023-09-11', 'dutchmill-64f56e1fa2939-64fe971262c90.jpeg'),
...
(24, 19, 2, 'Apple', 15, 100, 1300, '2023-09-11', 'apple-64f54ac5b3da4-64fe980226904.jpg'),
(25, 17, 2, 'Lemonade', 15, 20, 200, '2023-09-11', 'lemonade-64f551159d2da-64fe985e2ff5d.jpg'),
(26, 18, 2, 'Fita', 8, 50, 320, '2023-09-11', 'fita-64f54a56dbb8a-64fe98947f16a.jpeg'),
(27, 18, 2, 'Fita Spreadz', 9, 100, 800, '2023-09-11', 'fita-64f56f51d1b65-64fe98c0e5f9b.jpeg'),
(28, 18, 2, 'Hansel', 8, 20, 110, '2023-09-11', 'hansel-choco-sandwich-64ee0ae77871c-64fe9914ef205.jpg'),
...
(31, 22, 3, 'Nova', 15, 50, 600, '2023-09-11', 'nova-64fea62d0db5e.jpeg'),
(32, 22, 3, 'Cracklings', 9, 20, 120, '2023-09-11', 'cracklings-64fea672772d2.jpeg'),
(33, 20, 3, 'Le Minerale', 25, 50, 900, '2023-09-11', 'le minerale-64fea6a4b1bca.jpg'),
...
(44, 27, 4, 'Wet wipes', 20, 20, 300, '2023-09-11', 'wipes-64fead2067002.jpg'),
(45, 27, 4, 'Tissue roll', 10, 20, 120, '2023-09-11', 'tissue-64fead5c39d15.jpeg'),
(46, 26, 4, 'Yellow pad', 60, 10, 550, '2023-09-11', 'yellow pad-64fead88279df.jpeg'),
...
(54, 17, 2, 'Gulaman', 15, 20, 150, '2023-09-11', 'gulaman-64feb1711b91e.jpeg'),
...
--
-- Table structure for table `request_personnel_tb`
--

CREATE TABLE `request_personnel_tb` (
  `user_id` int(11) NOT NULL,
  `request_personnel_id` int(11) NOT NULL,
  `request_department` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `request_student_tb`
--

CREATE TABLE `request_student_tb` (
  `user_id` int(11) NOT NULL,
  `request_studentID_number` bigint(20) NOT NULL,
  `request_course` varchar(20) DEFAULT NULL,
  `request_year` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `cashiertransaction_tb`
--
ALTER TABLE `cashiertransaction_tb`
  ADD PRIMARY KEY (`cashierTransaction_id`),
...
--
-- Indexes for table `request_personnel_tb`
--
ALTER TABLE `request_personnel_tb`
  ADD PRIMARY KEY (`request_personnel_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `request_student_tb`
--
ALTER TABLE `request_student_tb`
  ADD KEY `user_id` (`user_id`);
...
--
-- AUTO_INCREMENT for table `cashiertransaction_tb`
--
ALTER TABLE `cashiertransaction_tb`
  MODIFY `cashierTransaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `request_personnel_tb`
--
ALTER TABLE `request_personnel_tb`
  MODIFY `request_personnel_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `telleruser_tb`
--
ALTER TABLE `telleruser_tb`
  MODIFY `teller_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `userwebusages_tb`
--
ALTER TABLE `userwebusages_tb`
  MODIFY `userWebUsages_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
-- Constraints for table `cashiertransaction_tb`
--
ALTER TABLE `cashiertransaction_tb`
  ADD CONSTRAINT `cashierTransaction_tb_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_tb` (`user_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
-- Constraints for table `request_personnel_tb`
--
ALTER TABLE `request_personnel_tb`
  ADD CONSTRAINT `request_personnel_tb_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_tb` (`user_id`);

--
-- Constraints for table `request_student_tb`
--
ALTER TABLE `request_student_tb`
  ADD CONSTRAINT `request_student_tb_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_tb` (`user_id`);
