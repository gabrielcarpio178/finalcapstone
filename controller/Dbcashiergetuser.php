...
if(isset($_POST['user_id'])){
    ...
    try {
        $sql_totalPurchase =  mysqli_query($connect, "SELECT IFNULL(SUM(order_tb.order_amount), 0) AS total_purchase, order_tb.user_id FROM order_tb WHERE order_tb.user_id = '$user_id'  AND order_tb.statues = NULL GROUP BY order_tb.user_id;");
